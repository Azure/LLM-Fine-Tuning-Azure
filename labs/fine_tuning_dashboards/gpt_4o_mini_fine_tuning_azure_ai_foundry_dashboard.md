...
* Fine-tuning access requires **Cognitive Services OpenAI Contributor** in the Azure AI Foundry resource.
* [OPTIONAL] An [Azure OpenAI connection](https://learn.microsoft.com/en-us/azure/ai-foundry/how-to/connections-add?tabs=azure-openai#connection-details) to a resource in a [region where fine-tuning is supported.](https://learn.microsoft.com/en-us/azure/ai-services/openai/concepts/models#fine-tuning-models)
...
* Prepare Training and Validation datasets:
  ...
  * The following guide will provide a sample dataset, but you may use your own dataset.
...
1. Choose your fine-tuning method: **Supervised** or **Direct Preference Optimization** or **Reinforcement**.
   * In this guide we will use **Supervised**(SFT).

1. Click the **Add training data** bottom to upload your training data using one of the following options:
...
1. In the **Training data** section, select **Upload files** and then click the **Upload file** bottom.
1. Upload the [Text-GSM8K chat_train.jsonl file](../sample_datasets/Text-GSM8K/chat_train.jsonl)
...
1. Upload the [Text-GSM8K chat_validation.jsonl file](../sample_datasets/Text-GSM8K/chat_validation.jsonl)
...
1. Select your previously fine-tuned model as the base model (e.g., `gpt-4o-mini-2025-04-14.ft-...`).  
